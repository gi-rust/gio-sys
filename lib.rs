...
pub struct GDatagramBasedInterface {
    pub g_iface: gobject::GTypeInterface,
    pub receive_messages: Option<extern "C" fn (*mut GDatagramBased, *mut GInputMessage, guint, gint, i64, *mut GCancellable, *mut *mut glib::GError) -> gint>,
    pub send_messages: Option<extern "C" fn (*mut GDatagramBased, *mut GOutputMessage, guint, gint, i64, *mut GCancellable, *mut *mut glib::GError) -> gint>,
    ...
    pub condition_wait: Option<extern "C" fn (*mut GDatagramBased, glib::GIOCondition, i64, *mut GCancellable, *mut *mut glib::GError) -> gboolean>,
}
...
extern {
    ...
    pub fn g_datagram_based_receive_messages(datagram_based: *mut GDatagramBased, messages: *mut GInputMessage, num_messages: guint, flags: gint, timeout: i64, cancellable: *mut GCancellable, error: *mut *mut glib::GError) -> gint;
    pub fn g_datagram_based_send_messages(datagram_based: *mut GDatagramBased, messages: *mut GOutputMessage, num_messages: guint, flags: gint, timeout: i64, cancellable: *mut GCancellable, error: *mut *mut glib::GError) -> gint;
    ...
    pub fn g_socket_receive_messages(socket: *mut GSocket, messages: *mut GInputMessage, num_messages: guint, flags: gint, cancellable: *mut GCancellable, error: *mut *mut glib::GError) -> gint;
